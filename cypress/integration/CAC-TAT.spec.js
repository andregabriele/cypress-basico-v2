...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('exibe mensagem de erro ao submeter formulário com um e-mail com formatação', function() {
        cy.get('#firstName').type('Andre')
        cy.get('#lastName').type('Gabriele')
        cy.get('#email').type('andreluiz.gabriele@gmail,com')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function()  {
        ...
        cy.get('#lastName')
          .type('Gabriele')
          .should('have.value', 'Gabriele')
          .clear()
          .should('have.value', '')
        cy.get('#email')
          .type('andreluiz.gabriele@gmail.com')
          .should('have.value', 'andreluiz.gabriele@gmail.com')
          .clear()
          .should('have.value', '')
        cy.get('#phone')
          .type('1234567890')
